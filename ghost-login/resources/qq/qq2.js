...
function ptui_auth_CB(t, e) {
    switch (window.clearTimeout(pt.preload.auth_timeout),
    parseInt(t)) {
    case 0:
        {
    ...
    case 2:
        ...
        switch ("1" == pt.ptui.pt_light && (i += "&pt_light=1"),
        pt.ptui.target) {
        case "_self":
            location.href = i;
            break;
...
function ptuiCB(t, e, i, n, o) {
    ...
    var s = g_time.time13 - g_time.time12
      , p = 0;
    switch (0 > s || (3e3 >= s ? p = 11 : 5e3 >= s && (p = 12)),
    p > 0 && pt.login.loginResultReport(p),
    pt.login.hideLoading(),
    pt.login.lastCheckAccout = "",
    pt.login.hasSubmit = !0,
    t) {
    case "0":
        if (pt.login.isQrLogin && !pt.login.is_mibao(i) && window.clearInterval(pt.login.qrlogin_clock),
        pt.preload.hasReportAuth) {
    ...
    "10005" == t || "12" == t || "51" == t ? (o += pt.login.aqScanLink,
    pt.login.show_err(o, !0)) : pt.login.isQrLogin || 0 == t || pt.login.show_err(o),
    pt.login.hasCheck || pt.login.isQrLogin || (pt.login.showVC(),
    $("verifycode").focus(),
    $("verifycode").select())
}
function ptui_checkVC(t, e, i, n, o) {
    switch (clearTimeout(pt.login.checkClock),
    pt.login.isRandSalt = o,
    pt.login.salt = i,
    pt.login.checkRet = t,
    "2" == t ? pt.login.show_err(pt.str.inv_uin) : "3" == t || pt.login.hasSubmit || pt.login.hide_err(),
    t + "") {
    case "0":
    case "2":
    case "3":
    ...
    var r = g_time.time7 - g_time.time6
      , a = 0;
    0 > r || (a = 3e3 >= r ? 11 : 5e3 >= r ? 12 : 13,
    pt.login.checkResultReport(a))
}
...
$.e = {
    ...
    _find: function(t, e, i) {
        ...
        if (!n)
            return -1;
        for (var o = t.document || t, r = o.parentWindow, a = n.length - 1; a >= 0; a--) {
            var s = n[a]
              , p = r._allHandlers[s];
            if (p.eventType == e && p.handler == i)
                return a
        }
        return -1
    },
    ...
    return {
        ...
        getOffsetPosition: function(e) {
            ...
            if (t.getBoundingClientRect && e.getBoundingClientRect) {
                ...
                n = o.left + this.getPageScrollLeft() - a
            } else
                do
                    i += e.offsetTop || 0,
                    n += e.offsetLeft || 0,
        ...
        updateClass: function(t, e, i) {
            for (var n = t.className.split(" "), o = {}, r = 0, a = n.length; a > r; r++)
                n[r] && (o[n[r]] = !0);
            if (e) {
                var s = e.split(" ");
                for (r = 0,
    ...
    fade: function(t, e, i, n, o) {
        if (t = $(t)) {
            ...
            var i = i || 1
              ...
              , l = p(t)
              , c = a > l ? 1 : -1;
            -1 != s.indexOf("msie") && 15 > n && (i = Math.floor(15 * i / n),
            n = 15);
            var u = function() {
                l += i * c,
                (Math.round(l) - a) * c >= 0 ? (t.style.opacity = a / 100,
    ...
    animate: function(t, e, i, n, o) {
        if (t = $(t)) {
            ...
            if (-1 == c.indexOf("msie") || "BackCompat" != document.compatMode) {
                ...
                "number" == typeof h && (l.push("height"),
                e.height = h - u.paddingTop.replace(/\D/g, "") - u.paddingBottom.replace(/\D/g, "")),
                15 > n && (i = Math.floor(15 * i / n),
                n = 15)
            }
            var d = e.left || 0 == e.left ? parseInt(e.left) : null 
              , m = e.top || 0 == e.top ? parseInt(e.top) : null ;
            "number" == typeof d && (l.push("left"),
            t.style.position = "absolute"),
            "number" == typeof m && (l.push("top"),
            t.style.position = "absolute");
            for (var f = [], _ = l.length, r = 0; _ > r; r++)
                f[l[r]] = p[l[r]] < e[l[r]] ? 1 : -1;
            var v = t.style
              , w = function() {
                for (var n = !0, r = 0; _ > r; r++)
                    p[l[r]] = p[l[r]] + f[l[r]] * Math.abs(e[l[r]] - p[l[r]]) * i / 100,
                    (Math.round(p[l[r]]) - e[l[r]]) * f[l[r]] >= 0 ? (n = n && !0,
...
$.getLoginQQNum = function() {
    try {
        ...
        var l = a.message || a;
        return /^pt_windows_sso/.test(l) ? (/^pt_windows_sso_\d+_3/.test(l) ? $.report.nlog("QQ插件不支持该url" + a.message, 326044) : $.report.nlog("QQ插件抛出内部错误" + a.message, 325361),
        $.sso_state = 1) : p && "msie" == $.browser("type") ? "Win64" != window.navigator.platform ? ($.report.nlog("可能没有安装QQ" + a.message, 322340),
...
pt.setHeader = function(t) {
    for (var e in t)
        "" != e && $("auth_face") && ($("auth_face").src = t[e] && t[e].indexOf("sys.getface.qq.com") > -1 ? pt.login.dftImg : t[e])
}
;
...
pt.preload = function() {
    var t = ""
      ...
      , c = function() {
        if ("" != pt.ptui.jumpname)
            -1 != pt.ptui.qtarget && (pt.ptui.qtarget = parseInt(pt.ptui.qtarget));
        else
      ...
      , u = function(e) {
        ...
        _("login"),
        e && 0 == pt.ptui.auth_mode && (a = !0,
        s = encodeURIComponent(e)),
        t = pt.ptui.pt_size,
        pt.ptui.enable_qlogin && (n = $.getLoginQQNum(),
        n += a ? 1 : 0),
        ...
        b(!1)) : ($("login").className = "login_no_qlogin",
        $("switch_login").innerHTML = pt.str.h_other_login,
        b(!0, !0),
        _("login"),
        $("u").value && "function" == typeof pt.login && 0 == pt.ptui.auth_mode && pt.login.check()),
      ...
      , h = function() {
        ...
        pt.ptui.daid && "1" != pt.ptui.noAuth && "" != t ? ($.css.hide($("login")),
        pt.preload.auth_timeout = window.setTimeout(function() {
            pt.preload.init()
        }, 5e3),
        $.http.loadScript(r),
        window.g_superuin = t.replace(/^o0*/, "")) : pt.preload.init()
    }
      , d = function(t) {
      ...
      , m = function() {
        if (!p && $("qrswitch")) {
            if ("1" == pt.ptui.isCdn)
                d(pt.ptui.cdnCssPath + "/h_cdn_qr_login.css?max_age=86400");
            else {
                var t = pt.ptui.cssPath + "/h_qr_login_1.css";
                try {
                    var e = $.localData.get("cssCacheFlag");
                    switch (e || (e = Math.floor(100 * Math.random()),
                    $.localData.set("cssCacheFlag", e)),
                    e + "") {
                    case "1":
                        t += "?v=" + Math.random();
                        break;
      ...
      , f = function() {
        try {
            ...
            if (pt.ptui.isHttps)
                e = $.check.isSsl() ? "flag1=7808&flag2=1&flag3=8" : "flag1=7808&flag2=1&flag3=12",
                $.report.setSpeedPoint(e, 1, (new Date).getTime()),
                $.report.isdSpeed(e);
            else if ("11" == pt.ptui.style)
                switch (t + "") {
                case "1":
                case "2":
                case "3":
      ...
      , _ = function(e) {
        try {
            1 == x() && ($("bottom_web") && $.css.hide($("bottom_web")),
        ...
        if ("1" == pt.ptui.no_drop_domain) {
            ...
            try {
                ...
                if (n) {
                    ...
                    if ("1" == s)
                        return;
                    parent.ptlogin2_onResize ? (parent.ptlogin2_onResize(width, height),
                    window.scroll(0, 10)) : (frameElement.width = width,
      ...
      , w = function() {
        if (e)
            return void ($("qlogin").style.display = "block");
        var t = v()
          , i = $("qlogin")
          , n = 265;
        12 == pt.ptui.style,
...
$.RSA = $pt.RSA = function() {
    ...
    function v(t) {
        ...
        var i, n = (1 << e) - 1, o = !1, r = "", a = this.t, s = this.DB - a * this.DB % e;
        if (a-- > 0)
            for (s < this.DB && (i = this[a] >> s) > 0 && (o = !0,
            r = u(i)); a >= 0; )
                e > s ? (i = (this[a] & (1 << s) - 1) << e - s,
                i |= this[--a] >> (s += this.DB - e)) : (i = this[a] >> (s -= e) & n,
                0 >= s && (s += this.DB,
                --a)),
                i > 0 && (o = !0),
                o && (r += u(i));
    ...
    function x(t, e) {
        var i, n = t % this.DB, o = this.DB - n, r = (1 << o) - 1, a = Math.floor(t / this.DB), s = this.s << n & this.DM;
        for (i = this.t - 1; i >= 0; --i)
            e[i + a + 1] = this[i] >> o | s,
            s = (this[i] & r) << n;
        for (i = a - 1; i >= 0; --i)
    ...
    st && "Microsoft Internet Explorer" == navigator.appName ? (a.prototype.am = l,
    rt = 30) : st && "Netscape" != navigator.appName ? (a.prototype.am = p,
    rt = 26) : (a.prototype.am = c,
    rt = 28),
    a.prototype.DB = rt,
    ...
    B.prototype.revert = U,
    B.prototype.reduce = Q,
    B.prototype.mulTo = V,
    B.prototype.sqrTo = F,
...
function(t) {
    ...
    function u(t) {
        for (var e = 16, o = i(t, 0, 4), r = i(t, 4, 4), a = i(m, 0, 4), s = i(m, 4, 4), p = i(m, 8, 4), l = i(m, 12, 4), c = 0, u = 2654435769; e-- > 0; )
            c += u,
            c = (4294967295 & c) >>> 0,
            o += (r << 4) + a ^ r + c ^ (r >>> 5) + s,
            o = (4294967295 & o) >>> 0,
    ...
    function g(t) {
        for (var e = 16, o = i(t, 0, 4), r = i(t, 4, 4), a = i(m, 0, 4), s = i(m, 4, 4), p = i(m, 8, 4), l = i(m, 12, 4), c = 3816266640, u = 2654435769; e-- > 0; )
            r -= (o << 4) + p ^ o + c ^ (o >>> 5) + l,
            r = (4294967295 & r) >>> 0,
            o -= (r << 4) + a ^ r + c ^ (r >>> 5) + s,
            o = (4294967295 & o) >>> 0,
    ...
    t.TEA = {
        ...
        enAsBase64: function(t, e) {
            for (var i = d(t, e), n = p(i), o = "", r = 0; r < n.length; r++)
    ...
    q.encode = function(t) {
        ...
        var e, i, n = q.PADCHAR, o = q.ALPHA, r = q.getbyte, a = [];
        t = "" + t;
...
$.Encryption = $pt.Encryption = function() {
    ...
    function core_md5(t, e) {
        t[e >> 5] |= 128 << e % 32,
        t[(e + 64 >>> 9 << 4) + 14] = e;
        for (var i = 1732584193, n = -271733879, o = -1732584194, r = 271733878, a = 0; a < t.length; a += 16) {
            var s = i
              , p = n
              , l = o
              , c = r;
    ...
    function getEncryption(t, e, i, n) {
        i = i || "",
        t = t || "";
        for (var o = n ? t : md5(t), r = hexchar2bin(o), a = md5(r + e), s = $pt.RSA.rsa_encrypt(r), p = (s.length / 2).toString(16), l = TEA.strToBytes(i.toUpperCase(), !0), c = Number(l.length / 2).toString(16); c.length < 4; )
            c = "0" + c;
        for (; p.length < 4; )
            p = "0" + p;
        TEA.initkey(a);
...
pt.login = {
    ...
    generateEmailTips: function(t) {
        ...
        for (var n = [], o = 0, r = pt.login.knownEmail.length; r > o; o++)
            n.push(i + "@" + pt.login.knownEmail[o]);
        for (var a = [], s = 0, r = n.length; r > s; s++)
            n[s].indexOf(t) > -1 && a.push($.str.encodeHtml(n[s]));
        return a
    },
    createEmailTips: function(t) {
        ...
        if (i = Math.min(i, r),
        0 == i)
            return pt.login.list_index[0] = -1,
            void pt.login.hideEmailTips();
        for (var a = 0; i > a; a++) {
            if (t == e[a])
                return void pt.login.hideEmailTips();
            o = "emailTips_" + a,
    ...
    setUrl: function() {
        ...
        2 == pt.ptui.regmaster ? (pt.login.checkUrl = "http://check.ptlogin2.function.qq.com/check",
        pt.login.loginUrl = "http://ptlogin2.function.qq.com/") : 3 == pt.ptui.regmaster && (pt.login.checkUrl = (pt.ptui.isHttps ? "https://ssl." : "http://") + "check.ptlogin2.crm2.qq.com/check",
    ...
    init: function() {
        ...
        pt.ptui.isHttps && (pt.login.delayTime = 7e3,
    ...
    antiProcess: function() {
        ...
        i ? t.style.border = "0px" : (t.appendChild(e),
        e.style.cssText = "background:url(http://imgcache.qq.com/ptlogin/v4/style/0/images/icons.gif) no-repeat 0 0;height:21px;font-weight:bold;font-size:12px;padding:7px 0 0 30px;border-bottom:1px solid #438ece;",
        t.style.border = "1px solid #99c2ee");
    ...
    vipTest: function() {
        var t = $("vip_link2")
          , e = $("vip_dot");
        !t || !e || pt.ptui.needVip && "2052" == pt.ptui.lang || ($.css.addClass(t, "hide"),
        $.css.addClass(e, "hide"))
    },
    set_default_uin: function(t) {
        t || (t = unescape($.cookie.getOrigin("ptui_loginuin")),
        pt.ptui.appid != pt.login.t_appid && ($.check.isNick(t) || $.check.isName(t)) && (t = $.cookie.get("pt2gguin").replace(/^o/, "") - 0,
        t = 0 == t ? "" : t)),
        $("u").value = t,
        t && ($.css.hide($("uin_tips")),
        $.css.show($("uin_del")),
    ...
    set_accout: function() {
        var t = $.str.trim($("u").value)
          , e = pt.ptui.appid;
        if (pt.login.accout = t,
        pt.login.at_accout = t,
        $.check.is_weibo_appid(e)) {
            if ($.check.isQQ(t) || $.check.isMail(t))
                return !0;
            if ($.check.isNick(t) || $.check.isName(t))
                return pt.login.at_accout = "@" + t,
                !0;
            if ($.check.isPhone(t))
                return pt.login.at_accout = "@" + t.replace(/^(86|886)/, ""),
                !0;
            if ($.check.isSeaPhone(t))
                return pt.login.at_accout = "@00" + t.replace(/^(00)/, ""),
    ...
    showOperate: function() {
        "2052" == pt.ptui.lang && (pt.login.hideLoading(),
        pt.login.hide_err(),
    ...
    showLowList: function() {
        var t = $("combox_list");
        t && ($.css.show(t),
        pt.login.low_login_isshow = !0)
    },
    hideLowList: function() {
        var t = $("combox_list");
        t && ($.css.hide(t),
        pt.login.low_login_isshow = !1)
    },
    u_focus: function() {
    ...
    u_blur: function() {
        pt.login.hideOperate(),
        "" == $("u").value ? ($.css.show($("uin_tips")),
        $("uin_tips").className = "input_tips") : (pt.login.set_accout(),
        pt.login.check()),
    ...
    list_keydown: function(t, e) {
        ...
        1 == e && ($("combox_box").innerHTML = n[pt.login.list_index[e]].innerHTML,
        $("low_login_hour").value = n[pt.login.list_index[e]].getAttribute("value"))
    },
    ...
    u_keyup: function(t) {
        var e = this.value;
        "" == e ? ($.css.show($("uin_tips")),
        $.css.hide($("uin_del"))) : $.css.show($("uin_del"));
        var i = t.keyCode;
        i != pt.login.keyCode.UP && i != pt.login.keyCode.DOWN && i != pt.login.keyCode.ENTER && i != pt.login.keyCode.TAB && i != pt.login.keyCode.F5 && ($("u").value.indexOf("@") > -1 ? (pt.login.showEmailTips(),
        pt.login.createEmailTips($("u").value)) : pt.login.hideEmailTips())
    },
    ...
    switchpage: function(t) {
        ...
        i.test(e) ? (pt.login.setQloginState(t.data),
        "3" == pt.login.getQloginState() && pt.preload.switchpage(!0)) : "hidePtui" == t.data
    },
    ...
    checkQloginState: function() {
        ...
        window.setTimeout(function() {
            if ($.loginQQnum > 0) {
                ...
                "2" != t && "2" != e && (pt.preload.switchpage(!0),
                "1" == t && Math.random() < .1 && (e ? $.report.nlog("没有收到xui跨域消息(3)", 282313) : $.report.nlog("没有收到xui跨域消息(2)", 282482))),
                3 == t && (pt.login.showAssistant(1),
                pt.login.showGuanjiaTips())
            } else
                1 == $.sso_state && /windows/.test(navigator.userAgent.toLowerCase()) ? pt.login.showAssistant(0) : 2 == $.sso_state && /windows/.test(navigator.userAgent.toLowerCase()) && pt.login.showAssistant(3)
        }, t),
    ...
    checkNPLoad: function() {
        ...
        window.console && console.log("np 回调没执行"))
    },
    ...
    bindEvent: function() {
        ...
        f && ($.e.add(f, "click", pt.login.authLogin),
        $.e.add(f, "mousedown", pt.login.authMouseDowm),
        $.e.add(f, "mouseup", pt.login.authMouseUp)),
        d && $.e.add(d, "click", pt.preload.cancleAuth),
        m && $.e.add(m, "click", pt.login.ptui_notifyClose),
        l && $.e.add(l, "click", function() {
            pt.preload.switchpage(!1)
        }),
        g && $.e.add(g, "click", pt.login.switch_qrlogin),
        c && $.e.add(c, "click", function(t) {
            t.preventDefault(),
            pt.preload.switchpage(!0)
        }),
        h && ($.e.add(h, "click", pt.login.bind_account),
        $.e.add(h, "mouseover", function() {
            pt.login.need_hide_operate_tips = !1
        }),
        $.e.add(h, "mouseout", function() {
            pt.login.need_hide_operate_tips = !0
        })),
        p && $.e.add(p, "click", pt.login.ptui_notifyClose),
        1 == pt.ptui.low_login && r && ($.e.add(r, "click", pt.login.checkbox_click),
        $.e.add(s, "click", pt.login.checkbox_click)),
        1 == pt.ptui.low_login && _ && ($.e.add(_, "click", pt.login.checkbox_click),
    ...
    checkValidate: function(t) {
        try {
            var e = t.u
              ...
              , n = t.verifycode;
            if ("" == $.str.trim(e.value))
                return pt.login.show_err(pt.str.no_uin),
                pt.login.domFocus(e),
                !1;
            if ($.check.isNullQQ(e.value))
                return pt.login.show_err(pt.str.inv_uin),
                pt.login.domFocus(e),
                !1;
            if ("" == i.value)
                return pt.login.show_err(pt.str.no_pwd),
                pt.login.domFocus(i),
                !1;
            if ("" == n.value)
                return pt.login.needVc || pt.login.vcFlag ? (pt.login.show_err(pt.str.no_vcode),
                pt.login.domFocus(n)) : (pt.login.checkResultReport(14),
                clearTimeout(pt.login.checkClock),
                pt.login.showVC()),
                !1;
            if (n.value.length < 4)
                return pt.login.show_err(pt.str.inv_vcode),
                pt.login.domFocus(n),
                n.select(),
                !1
        } catch (o) {}
    ...
    checkTimeout: function() {
        var t = $.str.trim($("u").value);
        ($.check.isQQ(t) || $.check.isQQMail(t)) && (pt.login.salt = $.str.uin2hex(t.replace("@qq.com", "")),
        pt.login.showVC(),
        pt.login.isCheckTimeout = !0,
        pt.login.checkRet = 1,
        pt.login.cap_cd = 0),
    ...
    check: function() {
        if (pt.login.accout || pt.login.set_accout(),
        $.check.isNullQQ(pt.login.accout))
            return pt.login.show_err(pt.str.inv_uin),
            !1;
    ...
    getSubmitUrl: function(t) {
        for (var e = document.forms[0], i = pt.login.loginUrl + t + "?", n = document.getElementById("login2qq"), o = 0; o < e.length; o++)
            if ("ptqrlogin" != t || "u" != e[o].name && "p" != e[o].name && "verifycode" != e[o].name && "h" != e[o].name)
                if ("ipFlag" != e[o].name || e[o].checked) {
                    if ("fp" != e[o].name && "submit" != e[o].type && ("ptredirect" == e[o].name && (g_ptredirect = e[o].value),
                    ("low_login_hour" != e[o].name || pt.login.low_login_enable) && ("webqq_type" != e[o].name || n || e[o].checked)))
                        if (i += e[o].name,
                        i += "=",
                        "u" != e[o].name) {
                            if ("p" == e[o].name) {
        ...
        "login" == t && (i += "&pt_vcode_v1=0",
        i += "&pt_verifysession_v1=" + (pt.login.pt_verifysession || $.cookie.get("verifysession"))),
        i
    },
    submit: function(t) {
        if (pt.login.submitTime = (new Date).getTime(),
        t && t.preventDefault(),
        !pt.login.ptui_onLogin(document.loginform))
            return !1;
        if ($.cookie.set("ptui_loginuin", escape(document.loginform.u.value), pt.ptui.domain, "/", 720),
        -1 == pt.login.checkRet || 3 == pt.login.checkRet)
            return pt.login.show_err(pt.login.checkErr[pt.ptui.lang]),
            pt.login.lastCheckAccout = "",
        ...
        pt.login.isVCSessionTimeOut() && !pt.login.needVc ? (pt.login.lastCheckAccout = "",
        pt.login.check(),
        window.setTimeout(function() {
            pt.login.submit()
    ...
    isVCSessionTimeOut: function() {
        ...
        pt.login.submitTime - pt.login.checkTime > 12e5 ? ($.report.monitor(330323, .05),
        !0) : !1
    },
    ...
    _ptui_notifyClose: function(t) {
        if (window.clearInterval(pt.login.qrlogin_clock),
        "1" == pt.ptui.no_drop_domain) {
            t && t.preventDefault();
            var e = {};
            e.action = "close",
            pt.crossMessage(e)
    ...
    ptui_onLogin: function(t) {
        ...
        try {
            if ("function" == typeof parent.ptlogin2_onLogin && !parent.ptlogin2_onLogin())
                return !1;
            if ("function" == typeof parent.ptlogin2_onLoginEx) {
                var i = t.u.value
                  , n = t.verifycode.value;
                if (!parent.ptlogin2_onLoginEx(i, n))
                    return !1
            }
        } catch (o) {}
        return e
    ...
    switch_qrlogin: function(t) {
        t && t.preventDefault(),
        pt.login.isQrLogin ? (pt.login.cancle_qrlogin(),
        $("qrswitch_logo").title = "二维码登录",
        $("qrswitch_logo").className = "qrswitch_logo",
        $.report.monitor("273368", .05)) : (pt.login.go_qrlogin_step(1),
    ...
    getShortWord: function(t, e, i) {
        ...
        e = e ? e : "";
        var n = "...";
        if (t.innerHTML = $.str.encodeHtml(e),
        t.clientWidth <= i)
            ;
        else
            for (var o = Math.min(e.length, 20), r = o; r > 0; r--) {
                var a = e.substring(0, r);
                if (t.innerHTML = $.str.encodeHtml(a + n),
                t.clientWidth <= i)
                    break
            }
        t.style.width = i + "px"
