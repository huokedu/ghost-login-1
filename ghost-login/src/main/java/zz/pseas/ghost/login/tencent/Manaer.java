...
public class Manaer {
    ...
    public int receiveMessage() throws IOException, JSONException {
    ...
    public void OnReceivePersonalMessage(Message m) throws JSONException {
    ...
    public void OnReceiveGroupMessage(Message m) throws JSONException {
        TLAnswer tLAnswer = new TLAnswer();
        String ans = tLAnswer.ask(m.content);
        SavedToLocal s = new SavedToLocal();
        s.save(m);
